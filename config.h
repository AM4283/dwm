...
static const Rule rules[] = {
    ...
    /* class      instance    title       tags mask  isfloating  isterminal
       noswallow  monitor    float x,y,w,h       floatborderpx */
    ...
    {"firefox", NULL, NULL, 1 << 1, 0, 0, -1, 1, 50, 50, 500, 500, 2},
    /* { "flameshot", NULL,       NULL,       0,          1,  0,  -1,  -1, -1,
       -1, -1, -1,      2}, */
    {"Galculator", NULL, NULL, 0, 1, 0, -1, -1, -1, -1, -1, -1, 2},
    /* { "Gimp",      NULL,       NULL,       0,          1,  0,   0,  -1, 50,
       50,500,500,      2}, */
    ...
    {"Steam", NULL, "Steam Guard - Computer Authorization Required", 0, 1, 0,
     -1, -1, -1, -1, -1, -1, 2},
...
static const char *roficmd[] = {"rofi",  "-modi", "window,ssh,drun,run",
                                "-show", "drun",  NULL};
...
static const char *trayer[] = {"trayer", "--widthtype", "pixel", "--width",
                               "20",     "--height",    "20",    "--align",
                               "right",  "--edge",      "top",   NULL};
...
// "Master", "5%+", NULL}; static const char *downvol[] = { "amixer", "-q",
// "-D", "pulse", "sset", "Master", "5%-", NULL}; static const char *mutevol[] =
...
static Key keys[] = {
    ...
    // Media Keys
    /* { 0,                  -1,          XF86XK_AudioLowerVolume, spawn, {.v =
       downvol } }, */
    /* { 0,                  -1,          XF86XK_AudioMute,        spawn, {.v =
       mutevol } }, */
    /* { 0,                  -1,          XF86XK_AudioRaiseVolume, spawn, {.v =
       upvol } }, */
    {0, -1, XF86XK_AudioMute, spawn,
     SHCMD("pamixer -t; pkill -RTMIN+2 dwmblocks")},
    {0, -1, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("pamixer -i 5; pkill -RTMIN+2 dwmblocks")},
    {0, -1, XF86XK_AudioLowerVolume, spawn,
     SHCMD("pamixer -d 5; pkill -RTMIN+2 dwmblocks")},
    /* { MODKEY, 	     	  -1,		   XK_F6, spawn,
       SHCMD("micmute; pkill -RTMIN+3 dwmblocks") }, */
    /* { MODKEY,    	      -1,		   XK_F8, spawn,
       SHCMD("micvolincrease; pkill -RTMIN+3 dwmblocks") }, */
    /* { MODKEY,    		  -1,		   XK_F7, spawn,
       SHCMD("micvoldecrease; pkill -RTMIN+3 dwmblocks") }, */
    {MODKEY, -1, XK_Home, spawn, SHCMD("micmute; pkill -RTMIN+3 dwmblocks")},
    {MODKEY, -1, XK_Prior, spawn,
     SHCMD("micvolincrease; pkill -RTMIN+3 dwmblocks")},
    {MODKEY, -1, XK_Next, spawn,
     SHCMD("micvoldecrease; pkill -RTMIN+3 dwmblocks")},
    ...
    /* { 0,                  -1,          XF86XK_MonBrightnessUp,   spawn, {.v =
       brightup } }, */
    /* { 0,                  -1,          XF86XK_MonBrightnessDown, spawn, {.v =
       brightdown } }, */
    /* { 0,                  -1,          XF86XK_MonBrightnessUp,   spawn,
       SHCMD("light -A 5; pkill -RTMIN+6 dwmblocks") }, */
    /* { 0,                  -1,          XF86XK_MonBrightnessDown, spawn,
       SHCMD("light -U 5; pkill -RTMIN+6 dwmblocks") }, */
    /* { MODKEY,             -1,          XK_F4,                   spawn,
       SHCMD("toggletouchpad") }, */
